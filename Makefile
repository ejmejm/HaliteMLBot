...
rl_training:  data/${FILE} ${SOURCES_FOR_TRAINING}
	mkdir -p models/
	python3 -m reinforcementLearner.train --model_name rl_training --data data/${FILE} --games_limit 100 --steps 500 --seed ${SEED}
